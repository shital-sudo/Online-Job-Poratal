					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Mangalvar Peth,Pune, <br/> Maharashtra<br/>411011</address>
								</li>
								<li>
										<h5>Email</h5><a href="shraddhasalunke00s@gmail.com">shraddhasalunke00s@gmail.com</a>
								</li>
                                <li>
								<a href="talekarprajakta0@gmail.com">talekarprajakta0@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="9322784383">9322784383</a>
								</li>
                                <li>
						        <a href="7040540340">7040540340</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Careerconnect is a job portal, online job management system developed by Shraddha Salunke and Prajakta Talekar for his project in May 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">CareerConnect Contact</h5>
								
								<p>Address :Mangalvar Peth,Pune, Maharashtra 411011</p>
								<p>Email : <a href="mailto:shraddhasalunke00s@gmail.com">shraddhasalunke00s@gmail.com</a></p>
                                <p><a href="mailto:talekarprajakta0@gmail.com">talekarprajakta0@gmail.com</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Shraddha Salunke and Prajakta Talekar</a></li>
								</ul>
